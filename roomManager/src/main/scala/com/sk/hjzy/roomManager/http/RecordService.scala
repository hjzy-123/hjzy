...
import com.sk.hjzy.protocol.ptcl.client2Manager.http.AdminProtocol.DeleteRecordReq
import com.sk.hjzy.protocol.ptcl.client2Manager.http.StatisticsProtocol
import com.sk.hjzy.roomManager.Boot.{executor, scheduler, userManager}
