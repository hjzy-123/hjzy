...
//import com.sk.hjzy.protocol.ptcl.processer2Manager.ProcessorProtocol
//import com.sk.hjzy.protocol.ptcl.processer2Manager.ProcessorProtocol.{RecordData, RecordInfoRsp, RecordList}
import com.sk.hjzy.protocol.ptcl.distributor2Manager.DistributorProtocol
import com.sk.hjzy.protocol.ptcl.distributor2Manager.DistributorProtocol.{StartPullReq, StartPullRsp, FinishPullReq, CheckStreamReq, CheckStreamRsp, SeekRecord, RecordInfoRsp}
import com.sk.hjzy.roomManager.common.AppSettings.{distributorDomain, distributorUseIp, distributorIp, distributorPort}
import com.sk.hjzy.roomManager.http.ServiceUtils.CommonRsp
import com.sk.hjzy.roomManager.utils.ProcessorClient.{log, postJsonRequestSend}
