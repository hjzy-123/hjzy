...
import com.sk.hjzy.roomManager.core.UserManager.{log => _, _}

import scala.language.postfixOps
import akka.http.scaladsl.server.Directives._
import akka.http.scaladsl.server.Route
import com.sk.hjzy.roomManager.Boot.{executor, roomManager, scheduler, userManager}
import akka.actor.typed.scaladsl.AskPattern._
import akka.http.scaladsl.model.StatusCodes
import akka.http.scaladsl.model.ws.Message
import akka.stream.scaladsl.Flow
import com.sk.hjzy.protocol.ptcl.{CommonRsp, Response}
import com.sk.hjzy.roomManager.core.RegisterActor.{ConfirmEmail, SendEmail}
import com.sk.hjzy.roomManager.core.RoomManager
import com.sk.hjzy.roomManager.models.dao.{StatisticDao, RecordDao, UserInfoDao}
import com.sk.hjzy.roomManager.utils.HestiaClient
import akka.http.scaladsl.model.headers._
import com.sk.hjzy.protocol.ptcl.CommonInfo.{RoomInfo, UserInfo}
import com.sk.hjzy.roomManager.common.{AppSettings, Common}
import com.sk.hjzy.roomManager.core.RoomManager.{GetRoomList, UserInfoChange}
