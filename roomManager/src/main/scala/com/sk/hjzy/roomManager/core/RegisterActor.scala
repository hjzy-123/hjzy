...
import com.sk.hjzy.protocol.ptcl
import com.sk.hjzy.protocol.ptcl.CommonRsp
import com.sk.hjzy.protocol.ptcl.client2Manager.http.CommonProtocol.{RegisterSuccessRsp, SignUpRsp}
import com.sk.hjzy.roomManager.Boot.{emailActor, executor, registerManager, scheduler, timeout}
import com.sk.hjzy.roomManager.common.AppSettings._
import com.sk.hjzy.roomManager.core.RegisterManager.RegisterFinished
