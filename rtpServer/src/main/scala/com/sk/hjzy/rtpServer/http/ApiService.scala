...
import com.sk.hjzy.rtpServer.core.DataStoreActor.{AllStreamData, NeedStreamData}
import com.sk.hjzy.rtpServer.core.{DataStoreActor, StreamManager}
import com.sk.hjzy.rtpServer.core.UserManager.GenLiveIdAndLiveCode
import com.sk.hjzy.rtpServer.protocol.ApiProtocol.{DelayReq, LiveInfo, PackageLossReq, StopStreamReq}
import com.sk.hjzy.rtpServer.utils.CirceSupport
import com.sk.hjzy.rtpServer.Boot.{dataStoreActor, publishManager, queryInfoManager, streamManager, userManager}
import com.sk.hjzy.rtpServer.core._
import com.sk.hjzy.rtpServer.protocol.ApiProtocol._
import com.sk.hjzy.rtpServer.core.DataStoreActor.AllStreamData
import com.sk.hjzy.rtpServer.protocol.SuccessRsp
import com.sk.hjzy.rtpServer.ptcl.ErrorRsp
...
trait ApiService extends BaseService with ServiceUtils with CirceSupport{
  ...
  private val getLiveInfo = (path("getLiveInfo") & post & pathEndOrSingleSlash) {
    dealGetReq {
      val rstF: Future[LiveInfo] = userManager ? GenLiveIdAndLiveCode
      rstF.map {rst =>
...
//  }
  ...
  private val getAllInfo = (path("getAllInfo") & get & pathEndOrSingleSlash){
    val msg: Future[AllStreamData] = dataStoreActor ? NeedStreamData
    dealFutureResult{
      msg.map{m =>
