...
import com.sk.hjzy.processor.Boot.{blockingDispatcher, roomManager}
import com.sk.hjzy.processor.common.AppSettings.{debugPath, isDebug, rtpServerDst, rtpToHost}
import com.sk.hjzy.processor.core.RoomManager.CloseRoom
import com.sk.hjzy.processor.core.StreamPullPipe.{ClosePipe, NewBuffer}
import com.sk.hjzy.rtpClient.Protocol.{Command, NoStream, PullStreamData, PullStreamPacketLoss, PullStreamReqSuccess, StreamStop}
import com.sk.hjzy.rtpClient.PullStreamClient
    ...
    Behaviors.setup[Command] { ctx =>
      ...
      Behaviors.withTimers[Command] {
        implicit timer =>
          ...
          val pullStreamDst = new InetSocketAddress(rtpToHost, 42044)
          val host = "0.0.0.0"
