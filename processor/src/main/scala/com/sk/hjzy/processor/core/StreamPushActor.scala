...
import com.sk.hjzy.processor.common.AppSettings.{distributorHost, rtpServerDst, rtpToHost}
import com.sk.hjzy.rtpClient.Protocol.{AuthRsp, Command, PushStreamError}
    ...
    Behaviors.setup[Command] { ctx =>
      ...
      Behaviors.withTimers[Command] {
        implicit timer =>
          ...
          val pushStreamDst = new InetSocketAddress(rtpToHost, 42043)
          val host = "0.0.0.0"
