package org.seekloud.hjzy.player.util

import org.seekloud.hjzy.player.Boot.executor
...
object RecordUtil extends HttpUtil with CirceSupport {
  ...
  def main1(args: Array[String]): Unit = {
    val url = "https://media.seekloud.org:50443/hjzy/distributor/getRecord/1000008/1569213160185/record.mp4"
